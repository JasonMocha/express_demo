...
CREATE TABLE `diningcar` (
  ...
  PRIMARY KEY (`id`),
  KEY `dingingcar-user` (`userId`),
  KEY `diningcar-food` (`foodId`),
  CONSTRAINT `dingingcar-user` FOREIGN KEY (`userId`) REFERENCES `user` (`id`),
  CONSTRAINT `diningcar-food` FOREIGN KEY (`foodId`) REFERENCES `food` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=gbk;

-- ----------------------------
-- Records of diningcar
-- ----------------------------
INSERT INTO `diningcar` VALUES ('7', '3', '7');
INSERT INTO `diningcar` VALUES ('11', '4', '1');
INSERT INTO `diningcar` VALUES ('12', '4', '2');
INSERT INTO `diningcar` VALUES ('13', '4', '3');
INSERT INTO `diningcar` VALUES ('28', '3', '38');
INSERT INTO `diningcar` VALUES ('29', '3', '40');
INSERT INTO `diningcar` VALUES ('32', '3', '10');
INSERT INTO `diningcar` VALUES ('33', '3', '11');
INSERT INTO `diningcar` VALUES ('40', '2', '2');
INSERT INTO `diningcar` VALUES ('41', '2', '11');
INSERT INTO `diningcar` VALUES ('42', '2', '21');
...
CREATE TABLE `food` (
  ...
  `feature` varchar(100) DEFAULT '暂无',
  `material` varchar(100) DEFAULT '暂无',
  ...
  PRIMARY KEY (`id`),
  KEY `food-foodtype` (`type`),
  CONSTRAINT `food-foodtype` FOREIGN KEY (`type`) REFERENCES `foodtype` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=gbk;

-- ----------------------------
-- Records of food
-- ----------------------------
INSERT INTO `food` VALUES ('1', '菠菜炒鸡蛋', '香甜可口', '主料：菠菜300克，鸡蛋3个，盐、料酒、葱末、姜末、味精、香油各适量。', '1', '1', '/images/uploads/01.jpg', '0', '0');
INSERT INTO `food` VALUES ('2', '韭菜炒鸡蛋', '工艺：炒    口味：清香味', '主料：韭菜4两（约160克），大鸡蛋3只。\r\n', '8', '1', 'images/jiachang/02.jpg', '2', '-1');
INSERT INTO `food` VALUES ('3', '渝味辣白菜', '特色：色泽红亮、酸甜微辣，脆爽可口。', '主料：娃娃菜200克。', '6', '1', 'images/jiachang/03.jpg', '1', '-1');
...
INSERT INTO `food` VALUES ('9', '木须肉', '暂无', '主料：猪肉、鸡蛋、木耳、黄瓜\r\n辅料：葱姜、盐、酱油、料酒、香油。', '8', '1', 'images/jiachang/01.jpg', '0', '-1');
...
INSERT INTO `food` VALUES ('21', '四川酸辣粉', '暂无', '粉条,葱末,姜末,蒜泥等', '28', '3', 'images/zhushi/1.jpg', '4', '-1');
INSERT INTO `food` VALUES ('22', '蛋包饭', '暂无', '蛋一个，炒饭6两', '6', '3', 'images/zhushi/2.jpg', '0', '-1');
...
INSERT INTO `food` VALUES ('43', 'qqqqq', 'qqqqqqqq', 'qqqqqqqqqqqqqqq', '21', '1', 'images/jiachang/03.jpg', '0', '-1');
...
INSERT INTO `user` VALUES ('5', '123', '123', '0', '123456', '1234567');
INSERT INTO `user` VALUES ('6', '12345', '123', '0', '123', '12345');
INSERT INTO `user` VALUES ('7', '123456', '123456', '0', '123', '12321321321');
